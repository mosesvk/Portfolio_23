...
const BackgroundCircles = (props: Props) => {
  return (
    <motion.div
      ...
      className='relative flex justify-center center'
    >
      <div className='absolute border border-[#3a769d] rounded-full h-[200px] w-[200px] mt-54' />
      <div className='absolute rounded-full border border-[#333333] h-[300px] w-[300px] mt-54' />
