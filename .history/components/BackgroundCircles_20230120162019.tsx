...
const BackgroundCircles = (props: Props) => {
  return (
    ...
    >
      ...
      <div className='rounded-full absolute border border-[#d82929] h-[700px] w-[700px] mt-52' />
      <div className='rounded-full absolute border border-[#d82929] h-[800px] w-[800px] mt-52' />
    </motion.div>
  );
};
